function [u] = greens_formula_nh_aperture(xtrg,ytrg,u_scat,C,params,kh,ww,...
...
if (flag==1)
 u = u+exp(ima*kh*(repmat(xtrg,1,n).*repmat(theta(1),m,1)+repmat(ytrg,1,n).*repmat(theta(2),m,1)));
end
